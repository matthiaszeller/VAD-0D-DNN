      ...
      //
        ...
        Q = max(0,
          if RPM == 2000 then
            ...
            if dP < 11.86 then 43.52
            else ( -0.136704 * dP ^ 2 ) + 3.24144 * dP + 24.3094
          else if RPM == 2900 then
            if dP < 12.08 then 45.97
            else ( -0.129379 * dP ^ 2 ) + 3.12535 * dP + 27.0979
          else if RPM == 3000 then
            if dP < 12.33 then 48.43
            else ( -0.122054 * dP ^ 2 ) + 3.00926 * dP + 29.8864
          else if RPM == 3100 then
            if dP < 12.61 then 50.91
            else ( -0.114729 * dP ^ 2 ) + 2.89317 * dP + 32.6748
          else if RPM == 3200 then
            if dP < 12.93 then 53.41
            else ( -0.107404 * dP ^ 2 ) + 2.77708 * dP + 35.4633
          else if RPM == 3300 then
            if dP < 13.29 then 55.94
            else ( -0.100079 * dP ^ 2 ) + 2.66099 * dP + 38.2517
          else if RPM == 3400 then
            if dP < 13.72 then 58.5
            else ( -0.0927537 * dP ^ 2 ) + 2.54491 * dP + 41.0402
          else if RPM == 3500 then
            if dP < 14.22 then 61.09
            else ( -0.0854286 * dP ^ 2 ) + 2.42882 * dP + 43.8287
          else if RPM == 3600 then
            if dP < 14.81 then 63.74
            else ( -0.0781036 * dP ^ 2 ) + 2.31273 * dP + 46.6171
          else if RPM == 3700 then
            if dP < 15.52 then 66.45
            else ( -0.0707785 * dP ^ 2 ) + 2.19664 * dP + 49.4056
          else if RPM == 3800 then
            if dP < 16.39 then 69.25
            else ( -0.0634535 * dP ^ 2 ) + 2.08055 * dP + 52.194
          else if RPM == 3900 then
            if dP < 17.5 then 72.17
            else ( -0.0561285 * dP ^ 2 ) + 1.96446 * dP + 54.9825
          else if RPM == 4000 then
            if dP < 18.94 then 75.27
            else ( -0.0488034 * dP ^ 2 ) + 1.84837 * dP + 57.771
          else if RPM == 4100 then
            if dP < 19.33 then 77.73
            else ( -0.0463825 * dP ^ 2 ) + 1.79321 * dP + 60.402
          else if RPM == 4200 then
            if dP < 19.77 then 80.21
            else ( -0.0439616 * dP ^ 2 ) + 1.73806 * dP + 63.033
          else if RPM == 4300 then
            if dP < 20.26 then 82.71
            else ( -0.0415407 * dP ^ 2 ) + 1.6829 * dP + 65.664
          else if RPM == 4400 then
            if dP < 20.8 then 85.23
            else ( -0.0391198 * dP ^ 2 ) + 1.62774 * dP + 68.295
          else if RPM == 4500 then
            if dP < 21.43 then 87.77
            else ( -0.0366989 * dP ^ 2 ) + 1.57258 * dP + 70.9261
          else if RPM == 4600 then
            if dP < 22.13 then 90.35
            else ( -0.034278 * dP ^ 2 ) + 1.51742 * dP + 73.5571
          else if RPM == 4700 then
            if dP < 22.95 then 92.97
            else ( -0.0318571 * dP ^ 2 ) + 1.46226 * dP + 76.1881
          else if RPM == 4800 then
            if dP < 23.9 then 95.63
            else ( -0.0294362 * dP ^ 2 ) + 1.4071 * dP + 78.8191
          else if RPM == 4900 then
            if dP < 25.02 then 98.36
            else ( -0.0270153 * dP ^ 2 ) + 1.35194 * dP + 81.4502
          else if RPM == 5000 then
            if dP < 26.36 then 101.2
            else ( -0.0245944 * dP ^ 2 ) + 1.29678 * dP + 84.0812
          else if RPM == 5100 then
            if dP < 26.75 then 103.1
            else ( -0.0233503 * dP ^ 2 ) + 1.24904 * dP + 86.3752
          else if RPM == 5200 then
            if dP < 27.17 then 105.0
            else ( -0.0221061 * dP ^ 2 ) + 1.2013 * dP + 88.6693
          else if RPM == 5300 then
            if dP < 27.65 then 106.9
            else ( -0.0208619 * dP ^ 2 ) + 1.15356 * dP + 90.9633
          else if RPM == 5400 then
            if dP < 28.18 then 108.8
            else ( -0.0196177 * dP ^ 2 ) + 1.10582 * dP + 93.2574
          else if RPM == 5500 then
            if dP < 28.79 then 110.8
            else ( -0.0183735 * dP ^ 2 ) + 1.05808 * dP + 95.5514
          else if RPM == 5600 then
            if dP < 29.49 then 112.7
            else ( -0.0171293 * dP ^ 2 ) + 1.01034 * dP + 97.8454
          else if RPM == 5700 then
            if dP < 30.3 then 114.7
            else ( -0.0158852 * dP ^ 2 ) + 0.962602 * dP + 100.139
          else if RPM == 5800 then
            if dP < 31.24 then 116.7
            else ( -0.014641 * dP ^ 2 ) + 0.914862 * dP + 102.434
          else if RPM == 5900 then
            if dP < 32.36 then 118.8
            else ( -0.0133968 * dP ^ 2 ) + 0.867122 * dP + 104.728
          else if RPM == 6000 then
            if dP < 33.71 then 120.8
            else ( -0.0121526 * dP ^ 2 ) + 0.819383 * dP + 107.022
          else if RPM == 6100 then
            if dP < 38.73 then 119.9
            else ( -0.0123094 * dP ^ 2 ) + 0.953555 * dP + 101.467
          else if RPM == 6200 then
            if dP < 43.63 then 119.6
            else ( -0.0124661 * dP ^ 2 ) + 1.08773 * dP + 95.9122
          else if RPM == 6300 then
            if dP < 48.4 then 119.9
            else ( -0.0126229 * dP ^ 2 ) + 1.2219 * dP + 90.3575
          else if RPM == 6400 then
            if dP < 53.06 then 120.8
            else ( -0.0127797 * dP ^ 2 ) + 1.35607 * dP + 84.8028
          else if RPM == 6500 then
            if dP < 57.6 then 122.2
            else ( -0.0129364 * dP ^ 2 ) + 1.49024 * dP + 79.248
          else if RPM == 6600 then
            if dP < 62.03 then 124.1
            else ( -0.0130932 * dP ^ 2 ) + 1.62441 * dP + 73.6933
          else if RPM == 6700 then
            if dP < 66.36 then 126.5
            else ( -0.0132499 * dP ^ 2 ) + 1.75859 * dP + 68.1386
          else if RPM == 6800 then
            if dP < 70.59 then 129.4
            else ( -0.0134067 * dP ^ 2 ) + 1.89276 * dP + 62.5839
          else if RPM == 6900 then
            if dP < 74.72 then 132.8
            else ( -0.0135634 * dP ^ 2 ) + 2.02693 * dP + 57.0292
          else if RPM == 7000 then
            if dP < 78.76 then 136.6
            else ( -0.0137202 * dP ^ 2 ) + 2.1611 * dP + 51.4744
          else if RPM == 7100 then
            if dP < 78.11 then 139.4
            else ( -0.0129013 * dP ^ 2 ) + 2.0155 * dP + 60.7082
          else if RPM == 7200 then
            if dP < 77.38 then 142.3
            else ( -0.0120824 * dP ^ 2 ) + 1.86989 * dP + 69.942
          else if RPM == 7300 then
            if dP < 76.54 then 145.2
            else ( -0.0112635 * dP ^ 2 ) + 1.72428 * dP + 79.1759
          else if RPM == 7400 then
            if dP < 75.57 then 148.1
            else ( -0.0104446 * dP ^ 2 ) + 1.57868 * dP + 88.4097
          else if RPM == 7500 then
            if dP < 74.44 then 151.0
            else ( -0.00962574 * dP ^ 2 ) + 1.43307 * dP + 97.6435
          else if RPM == 7600 then
            if dP < 73.09 then 153.9
            else ( -0.00880684 * dP ^ 2 ) + 1.28746 * dP + 106.877
          else if RPM == 7700 then
            if dP < 71.47 then 156.9
            else ( -0.00798795 * dP ^ 2 ) + 1.14186 * dP + 116.111
          else if RPM == 7800 then
            if dP < 69.48 then 160.0
            else ( -0.00716906 * dP ^ 2 ) + 0.996248 * dP + 125.345
          else if RPM == 7900 then
            if dP < 66.98 then 163.1
            else ( -0.00635017 * dP ^ 2 ) + 0.850642 * dP + 134.579
          else if RPM == 8000 then
            if dP < 63.73 then 166.3
            else ( -0.00553127 * dP ^ 2 ) + 0.705035 * dP + 143.812
          else if RPM == 9000 then
            if dP < 93.82 then 179.0
            else ( -0.0042916 * dP ^ 2 ) + 0.805248 * dP + 141.179
          else 0
        );
